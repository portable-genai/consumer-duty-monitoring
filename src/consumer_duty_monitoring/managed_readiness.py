...
INCOMPLETE_MANAGED_OPERATIONS: tuple[str, ...] = (
    "assessment_store.FirestoreAssessmentStore.get",
    "assessment_store.FirestoreAssessmentStore.list_for_product",
    "assessment_store.FirestoreAssessmentStore.put",
    "narration.GeminiNarrator.narrate",
    "product_governance.DocumentAiProductGovernance.load",
    "signal_source.BigQuerySignalSource.load",
)
