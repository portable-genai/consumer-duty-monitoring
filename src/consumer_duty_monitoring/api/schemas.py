...
class HealthResponse(BaseModel):
    ...
    #: the bound generator calls. Read off the service because the browser cannot know either.
    #: Once a request is answered, the pill shows that response's ``X-Answered-By`` instead.
